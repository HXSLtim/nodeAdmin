...
export function RegisterPage(): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password !== confirmPassword) {
      setError(t({ id: 'auth.confirmPassword' }) + ' mismatch');
      return;
    }
    setLoading(true);
    try {
      ...
      <Card className="w-full max-w-md p-6">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-name">{t({ id: 'auth.name' })}</Label>
            <Input
              autoComplete="name"
              id="reg-name"
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-email">{t({ id: 'auth.email' })}</Label>
            <Input
              autoComplete="email"
              id="reg-email"
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-password">{t({ id: 'auth.password' })}</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-confirm">{t({ id: 'auth.confirmPassword' })}</Label>
            <Input
              autoComplete="new-password"
              id="reg-confirm"
          ...
          <div className="space-y-2">
            <Label htmlFor="reg-tenant">{t({ id: 'auth.tenantId' })}</Label>
            {tenants.length > 0 ? (
              <select
